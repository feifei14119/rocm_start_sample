...
void RunTest()
{
	...
	CreateHipKernel("AtomicAdd", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	...
	CreateHipKernel("AtomicMax", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	PrintDeviceData(d_B, 1);
	printf("device C:\n");
	...
	CreateHipKernel("AtomicInc", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	PrintDeviceData(d_B, 1);
	printf("device C:\n");
	...
	CreateHipKernel("AtomicOr", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	PrintDeviceData(d_B, 1);
	printf("device C:\n");
	...
	CreateHipKernel("AtomicExch", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	PrintDeviceData(d_B, 1);
	printf("device C:\n");
	...
	CreateHipKernel("AtomicCAS", "hipAtomic.cpp");
	RunGpuCalculation();
	printf("device B:\n");
	PrintDeviceData(d_B, 1);
	printf("device C:\n");
