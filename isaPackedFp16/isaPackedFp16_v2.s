...
.globl isaPackedFp16
.p2align 8
.type isaPackedFp16,@function
.amdgpu_hsa_kernel isaPackedFp16
...
START_PROG:
	...
	// ------------------------------------------------------
	// v_c[31:16] = v_a[31:16] * v_b[31:16]
	// v_c[15:0]  = v_a[15:0]  * v_b[15:0]
	// ------------------------------------------------------
    v_pk_mul_f16		v[v_c],					v[v_a], v[v_b]								// c = a * b
...
.macro METADATA group_size, args_size
    ...
    { Version: [1, 0],
      Kernels :
        - { Name: isaPackedFp16, SymbolName: isaPackedFp16, Language: Assembler, LanguageVersion: [ 1, 2 ],
            Attrs:
