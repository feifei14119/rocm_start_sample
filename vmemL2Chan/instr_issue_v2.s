...
.globl instr_issue
.p2align 8
.type instr_issue,@function
.amdgpu_hsa_kernel instr_issue
...
START_PROG:
	...
	//
	// s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	// v_mov_b32 v[v_test+ 0], 3.14
	// v_add3_u32 v[v_test+ 0], v[v_test+ 0], v[v_test+ 0], v[v_test+ 0]
...
LOOP_SEG:
	...
	v_add3_u32 v[v_test+ 8], v[v_test+ 8], v[v_test+ 8], v[v_test+ 8]
	v_add3_u32 v[v_test+ 9], v[v_test+ 9], v[v_test+ 9], v[v_test+ 9]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	v_add3_u32 v[v_test+10], v[v_test+10], v[v_test+10], v[v_test+10]
	v_add3_u32 v[v_test+11], v[v_test+11], v[v_test+11], v[v_test+11]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	v_add3_u32 v[v_test+12], v[v_test+12], v[v_test+12], v[v_test+12]
	v_add3_u32 v[v_test+13], v[v_test+13], v[v_test+13], v[v_test+13]
	v_add3_u32 v[v_test+14], v[v_test+14], v[v_test+14], v[v_test+14]
	v_add3_u32 v[v_test+15], v[v_test+15], v[v_test+15], v[v_test+15]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	...
	v_add3_u32 v[v_test+15], v[v_test+15], v[v_test+15], v[v_test+15]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	flat_load_dword v[v_test+ 8], v[v_addr_a:v_addr_a + 1] offset:4* 8
	flat_load_dword v[v_test+ 9], v[v_addr_a:v_addr_a + 1] offset:4* 9
	flat_load_dword v[v_test+10], v[v_addr_a:v_addr_a + 1] offset:4*10
	flat_load_dword v[v_test+11], v[v_addr_a:v_addr_a + 1] offset:4*11
	v_add3_u32 v[v_test+ 0], v[v_test+ 0], v[v_test+ 0], v[v_test+ 0]
	v_add3_u32 v[v_test+ 1], v[v_test+ 1], v[v_test+ 1], v[v_test+ 1]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	v_add3_u32 v[v_test+ 2], v[v_test+ 2], v[v_test+ 2], v[v_test+ 2]
	v_add3_u32 v[v_test+ 3], v[v_test+ 3], v[v_test+ 3], v[v_test+ 3]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	v_add3_u32 v[v_test+ 4], v[v_test+ 4], v[v_test+ 4], v[v_test+ 4]
	v_add3_u32 v[v_test+ 5], v[v_test+ 5], v[v_test+ 5], v[v_test+ 5]
	v_add3_u32 v[v_test+ 6], v[v_test+ 6], v[v_test+ 6], v[v_test+ 6]
	v_add3_u32 v[v_test+ 7], v[v_test+ 7], v[v_test+ 7], v[v_test+ 7]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	flat_load_dword v[v_test+12], v[v_addr_a:v_addr_a + 1] offset:4*12
	flat_load_dword v[v_test+13], v[v_addr_a:v_addr_a + 1] offset:4*13
	flat_load_dword v[v_test+14], v[v_addr_a:v_addr_a + 1] offset:4*14
	flat_load_dword v[v_test+15], v[v_addr_a:v_addr_a + 1] offset:4*15
	v_add3_u32 v[v_test+ 0], v[v_test+ 0], v[v_test+ 0], v[v_test+ 0]
	v_add3_u32 v[v_test+ 1], v[v_test+ 1], v[v_test+ 1], v[v_test+ 1]
	s_add_u32 s[s_test+ 0], s[s_test+ 0], s[s_test+ 0]
	v_add3_u32 v[v_test+ 2], v[v_test+ 2], v[v_test+ 2], v[v_test+ 2]
...
.macro METADATA group_size, args_size
    ...
    { Version: [1, 0],
      Kernels :
        - { Name: instr_issue, SymbolName: instr_issue, Language: Assembler, LanguageVersion: [ 1, 2 ],
            Attrs:
