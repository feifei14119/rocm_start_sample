...
START_PROG:
    ...
    /* 
     * c[i] = a[i+1]
     * ds_permute_b32   v[dst], v[addr], v[src] offset:0~65535
     * to_addr = ((v[addr] + offset) / 4) % 64
     */ 
    v_add_u32           v[v_pmt_addr],          v[v_tid_x], 0x1
    v_lshlrev_b32       v[v_pmt_addr],          0x2, v[v_pmt_addr]

    ds_permute_b32      v[v_c],                 v[v_pmt_addr], v[v_a] offset:4
    s_waitcnt			lgkmcnt(0)
